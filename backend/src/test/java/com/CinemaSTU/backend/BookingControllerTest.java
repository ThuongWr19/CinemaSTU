package com.CinemaSTU.backend;

import com.CinemaSTU.backend.controller.BookingController;
import com.CinemaSTU.backend.dto.BookingRequest;
import com.CinemaSTU.backend.dto.BookingResponse;
...
import com.CinemaSTU.backend.repositories.BookingRepository;
...
class BookingControllerTest {
    ...
    void setUp() throws NoSuchFieldException, IllegalAccessException {
        ...
        showtime.setId(1L);
        showtime.setSeatMap("A1:available,A2:available,A3:booked");
        showtime.setAvailableSeats(2);
    ...
    void deleteBooking_Success() {
        ...
        ResponseEntity<?> response = bookingController.deleteBooking(1L, principal);
